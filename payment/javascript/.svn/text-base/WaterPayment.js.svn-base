...
function clearreferencenumber() {
    ...
    jQuery('#ReferenceValidation').html('Please enter the Water Account Number you wish to pay residential water rates for without any spaces or hyphens. The number can be found on the top right of your water account letter, starting with ‘W’, or through an online search.<br/><a href="/property/rates/rate-record-search/" target="_blank">Online property search</a><br/><a href="/contact-us/#Rates" target="_blank">Contact Us</a>');
...
function validatevid(fieldcheck){
    ...
    var url = 'payment/code/xmlrelay.php?t=water&id=' + str;
