...
*
* Changes made by Tama Easton from Tasman District Council: http://www.tasman.govt.nz
*/
...
//Tasman District Council removed
                                //dl.append($("<dd />").text(list[i][1]));
//Tasman District Council removed  
                                dl.data("text", list[i][0]);
//Tasman District Council added                        
                                dl.data("url", list[i][1]);
//Tasman District Council added                        
                            }
                            dl.hover(
								function(e) {
