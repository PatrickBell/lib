 ...
 **/
ExternalAuthenticator::setAuthDebug('/var/www/debug-logs/sstripe_debug.log');
 ...
 **/
ExternalAuthenticator::setAuditLogFile('/var/www/debug-logs/sstripe_audit.log');
 ...
 **/
ExternalAuthenticator::setAuthServer('tdcldap','tsrvdc3.tdc.tdc.govt.nz'); 
 ...
 **/
ExternalAuthenticator::setAutoAdd('tdcldap', 'Contributors');
...
/**
  ...
  **/
ExternalAuthenticator::setOption('tdcldap', 'bind_as','cn=SilverStripe WebDev_svc,ou=System Accounts,ou=Accounts,dc=tdc,dc=tdc,dc=govt,dc=nz'); 
ExternalAuthenticator::setOption('tdcldap', 'bind_pw','Dev@ACCESS2ad'); 
